-- Manual fallback for Supabase SQL Editor.
-- Apply this only if `npx supabase db push --linked` or
-- `npx supabase migration list --linked` cannot reach the remote project.
-- Project ref: qajjpjmybmqqwflytcpr
-- This migration is schema/RPC/index only. It does not delete or mutate user data.
--
