...
export function feedPostRowFromSurface(row: SurfacePostRow): FeedPostRow {
  return {
    ...
    workout_origin: row.workout_origin ?? null,
    workout_source_app: row.workout_source_app ?? null,
