          ...
          {step === 0 ? (
            ...
            >
              <div className="space-y-2 text-[13px] font-bold text-white/58">
                <a className="block rounded-[18px] bg-white/[0.05] px-4 py-3 text-white" href="/terms" target="_blank">
                  Termos de uso
                </a>
                <a className="block rounded-[18px] bg-white/[0.05] px-4 py-3 text-white" href="/privacy" target="_blank">
